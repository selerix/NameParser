...
namespace BinaryFog.NameParser {
	...
	public static class RegexNameComponents {
        ...
        public static readonly string LastNamePrefixes = RegexPipeJoin(ResourcesHelper.LastNamePrefixes);
		public static readonly string PostNominals = RegexPipeJoin(ResourcesHelper.PostNominals); // TODO: make use
		public static readonly string JobTitles = RegexPipeJoin(ResourcesHelper.JobTitles);
		public static readonly string Suffixes = RegexPipeJoin(ResourcesHelper.Suffixes);
		public static readonly string Titles = RegexPipeJoin(ResourcesHelper.Titles);
		public static readonly string CompanySuffixes = RegexPipeJoin(ResourcesHelper.CompanySuffixes);
