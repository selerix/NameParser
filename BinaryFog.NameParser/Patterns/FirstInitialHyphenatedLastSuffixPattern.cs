...
{
    internal class FirstInitialHyphenatedLastSuffixPattern : IFullNamePattern
    {
        private static readonly Regex Rx = new Regex(
            @"^" + First + Space + Initial + Space + LastHyphenated + Space + Suffix + @"$",
        ...
        public ParsedFullName Parse(string rawName)
        {
            ...
            var pn = new ParsedFullName
            {
                ...
                Score = 100 + scoreMod,
                Rule = nameof(FirstInitialHyphenatedLastSuffixPattern)
            };
            return pn;
        }
    }
